  ...
  return (
    <div className="relative bg-white py-16 sm:py-20 lg:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/3 text-black/5 text-xl">+</div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-[10px] sm:text-xs text-black/40 tracking-[0.3em] uppercase">Why INAD</span>
            <span className="w-6 sm:w-8 h-px bg-yellow-400/40"></span>
          </div>
            ...
            <div className="relative max-w-lg mx-auto lg:mx-0">
              ...
              <div className="relative grid grid-cols-2 gap-2">
                ...
                <div className="relative aspect-[3/4] overflow-hidden border-2 border-black col-span-1">
                  <img
                    src="https://images.pexels.com/photos/1852389/pexels-photo-1852389.jpeg?auto=compress&cs=tinysrgb&w=400"
              ...
              <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-black text-white p-4 sm:p-5 shadow-xl z-20">
                <div className="text-center">
                  ...
                  <div className="text-[10px] sm:text-xs text-white/60 mt-1">Placement Rate</div>
                </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-black/70 group-hover:text-yellow-600 transition-colors">
                        {item.icon}
                      </span>

...
const stories = [
  {
    ...
    company: "Khati Baba Design Studio",
    year: "2020",
    desc: "Kailash completed his Interior Architecture course with a clear vision: to create spaces that are smart and beautiful. He learned advanced designing techniques and how to solve real building problems. Using these skills, he opened Khati Baba Design Studio. His projects are known for mixing creativity with practical planning.",
    vision: "To create spaces that are smart and beautiful",
  },
  {
    id: 2,
    name: "Priya Sharma",
    ...
    company: "Priya Couture House",
    year: "2019",
    desc: "Priya discovered her passion for fashion design during her first year. She mastered pattern making, textile design, and garment construction. After graduation, she launched her own label that now showcases at India Fashion Week.",
    vision: "To redefine Indian fashion for the modern world",
  },
  {
    id: 3,
    name: "Rahul Verma",
    ...
    year: "2021",
    desc: "Rahul started with basic design principles and evolved into a brand identity specialist. He mastered typography, color theory, and digital illustration. His studio now serves over 50 clients worldwide.",
    vision: "To give every brand a unique visual voice",
  },
];
  ...
  return (
    <div className="relative bg-white py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Cross/Plus shapes */}
        <div className="absolute top-1/3 right-1/3 text-yellow-400/15 text-2xl font-light">+</div>
        <div className="absolute bottom-1/4 left-10 text-black/5 text-xl">+</div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-14">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-[10px] sm:text-xs text-black/40 tracking-[0.3em] uppercase">Testimonials</span>
            <span className="w-6 sm:w-8 h-px bg-yellow-400/40"></span>
          </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-0 shadow-2xl shadow-black/5">
                    ...
                    <div className="md:w-2/5 relative overflow-hidden">
                      <div className="aspect-[4/5] md:aspect-[3/4] relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4 md:hidden">
                          ...
                          <p className="text-white/60 text-xs mt-1">{story.course}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="md:w-3/5 bg-white text-black p-5 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center border border-black/5 border-l-0">
                      ...
                      <div className="hidden md:block mb-6">
                        <h3 className="text-2xl lg:text-3xl font-bold text-black">{story.name}</h3>
                        <div className="flex items-center gap-2 mt-2">
                          <span className="w-6 h-px bg-yellow-400"></span>
                          <span className="text-sm text-black/50">{story.course}</span>
                        </div>
                      </div>
                      ...
                      <div className="mb-4 md:mb-6 p-3 sm:p-4 bg-yellow-400/5 border-l-2 border-yellow-400">
                        <p className="text-xs text-black/40 uppercase tracking-wider mb-1">Vision</p>
                        <p className="text-sm md:text-base text-black/70 italic">"{story.vision}"</p>
                      </div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              {stories.map((_, index) => (
                <button
                  key={index}
                  onClick={() => {
                    const swiper = document.querySelector('.story-main-swiper')?.swiper;
